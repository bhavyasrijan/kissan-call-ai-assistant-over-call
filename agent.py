...
os.environ["GOOGLE_ACCOUNT_CREDENTIALS"] = "my_service_account.json"
os.environ['GOOGLE_API_KEY'] = 'AIzaSyC-ASsI6zwI9UiDcR9xqEH7SyeHl2MS8HY'

PROJECT_ID = "sixth-module-394805"
...
def send_sms_with_subsidy_info(query: str) -> str:
    ...
    account_sid = 'AC513a68479dae080b55a3f25db7e52616'
    auth_token = '6fc4e5468c2715683d99501349b93e3f'
...
llm = Vertex(temperature=0, model="gemini-1.5-pro-001")
